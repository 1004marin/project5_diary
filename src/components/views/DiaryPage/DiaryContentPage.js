    ...
    const fetchPosts = async() =>{
        ...
        // 서버에서 해당 월에 있는 포스트를 가져오는 API를 호출합니다.
            try {
                ...
                const response =await axios.get(`${CONFIG.API_BASE_URL}/api/v1/diary/${Client_diaryId}`, { params: { yearMonth: formattedDate } });
...
//멤버추가
    ...
    const onMemberInviteHandler=()=>{
        ...
        axios.post(`${CONFIG.API_BASE_URL}/api/v1/diary/${Client_diaryId}/member`, jsonAddMem)
        .then(response=>{

...
function DiaryPostPage() {
  ...
  const onDiaryDateHandler =(e) => {
    ...
    const onStampSubmitHandler=()=>{
      ...
      axios.post(`${CONFIG.API_BASE_URL}/api/v1/diary/${Client_diaryId}/${Client_postId}/react`, jsonStamp)
      .then(response => {
        alert("도장을 찍었어요!")
    ...
    const onDiaryDeleteHandler = ()=>{
      ...
      const storedAccessToken = localStorage.getItem("accessToken");
        ...
        axios.delete(`${CONFIG.API_BASE_URL}/api/v1/diary/${Client_diaryId}/post/${Client_postId}`)
        .then(response=>{
    ...
    useEffect(()=>{
        ...
        axios.get(`${CONFIG.API_BASE_URL}/api/v1/diary/${Client_diaryId}/post/${Client_postId}`)
        .then(response => {
        ...
        axios.get(`${CONFIG.API_BASE_URL}/api/v1/diary/${Client_diaryId}/${Client_postId}/react`)
        .then(response=>{
